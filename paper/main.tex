...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{paper/fig_field_coverage.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{paper/fig_completeness_tiers.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{paper/fig_bpm_distribution.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{paper/fig_key_distribution.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{paper/fig_source_heatmap.pdf}
...
\begin{itemize}
  ...
  \item \textbf{Dataset:} The 636-track Rekordbox XML export (anonymized) is included in the repository at \texttt{data/}. Track filenames and paths are anonymized; metadata fields are preserved.
  \item \textbf{Analysis Scripts:} \texttt{code/schema/udms_schema.py} contains the UDMS schema and adapters; \texttt{code/analyze.py} contains the analysis pipeline used to generate all figures and statistics.
  \item \textbf{Figures:} All figures are generated programmatically from the dataset; source scripts are in \texttt{code/}.
